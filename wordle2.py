"""
Computer plays wordle (First guess is "lares" then random).

:author:  Terry Sergeant
:version: 2

In this version the computer selects a predetermined beneficial starting
word and then takes random guesses out of remaining words.
"""
